            ...
            <form action="" method="post" class="form_edit">
                <table>
                    <tr>
                        ...
                        <td>Email:</td>
                        <td><input type="text" name="email"  value="<?= isset($_GET['red_id']) ? $user['email'] : ''; ?>"></td>
                        <td>Country:</td>
                        <td><input type="text" name="country"  value="<?= isset($_GET['red_id']) ? $user['country'] : ''; ?>"> </td>
            ...
            <table class="table table-striped table-hover">
                ...
                while ($result = mysqli_fetch_array($sql)) {
                    echo '<tr>' .
                        ...
                        "<td><i class=\"fas fa-user-minus\"></i> <a class='delete' href='?del_id={$result['id']}'>Видалити цього користувача</a></td>" .
                        "<td><i class=\"fas fa-user-edit\"></i> <a class='edit_u' href='?red_id={$result['id']}'>Редагувати цього користувача</a></td>" .
                        '</tr>';
                }
                ?>
            </table>
